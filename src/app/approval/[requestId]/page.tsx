...
import { removeBackgroundWithMediaPipe } from '@/lib/background-remover';
...
export default function ApprovalPage() {
    ...
    const handleFinalAcceptance = async () => {
        ...
        try {
            ...
            // AI Background Removal (client-side with Google MediaPipe)
            console.log("APPROVAL_PAGE: Processing profile photo with AI background removal (MediaPipe)...");
            toast({ title: 'Procesando foto de perfil...', description: 'Nuestra IA está eliminando el fondo... Por favor espera.' });

            let processedPhotoFile: File;
            try {
                // Remove background using new MediaPipe utility
                processedPhotoFile = await removeBackgroundWithMediaPipe(files.profilePhoto!, (status) => {
